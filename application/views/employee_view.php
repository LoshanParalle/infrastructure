		...
		$('#showdata').on('click', '.item-edit', function(){
			...
			$.ajax({
				...
				success: function(data){
					$('input[name=txtEmployeeName]').val(data.firstname);
					$('textarea[name=txtAddress]').val(data.surname);
			...
			$.ajax({
				...
				success: function(data){
                  ...
                  '<td>'+
                    ...
                    '<a href="javascript:;" class="btn btn-danger item-delete disabled" disabled data="'+data[i].id+'">Delete</a>'+
                  '</td>'+
                  '</tr>';
					}
					$('#showdata').html(html);
